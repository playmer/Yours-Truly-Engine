...
namespace YTE
{
  ...
  BufferMemory VulkanContext::CreateVertexBuffer(std::vector<Vertex> aVertices)
  {
    ...
    auto toReturn = CreateBuffer(bufferSize, vk::BufferUsageFlagBits::eTransferDst | vk::BufferUsageFlagBits::eVertexBuffer, vk::MemoryPropertyFlagBits::eDeviceLocal);

    CopyBuffer(bufferMemory.mBuffer, toReturn.mBuffer, bufferSize);
